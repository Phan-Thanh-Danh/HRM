        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BaseSalaryMin = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    BaseSalaryMax = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SalaryFormulas_SalaryComponents_SalaryComponentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CheckOutImage = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeeOnboardings_OnboardingTasks_OnboardingTaskId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StandardWorkDays = table.Column<double>(type: "float", nullable: false),
                    RealWorkDays = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeOnboardings_OnboardingTaskId",
                table: "EmployeeOnboardings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalaryFormulas_SalaryComponentId",
